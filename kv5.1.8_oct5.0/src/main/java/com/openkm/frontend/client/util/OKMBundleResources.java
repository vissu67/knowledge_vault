...
public interface OKMBundleResources extends ClientBundle {
	...
	@Source("com/openkm/frontend/public/img/icon/actions/zoho.gif")
	public ImageResource zoho();
	
	@Source("com/openkm/frontend/public/img/icon/actions/zoho_disable.gif")
	public ImageResource zohoDisabled();
	//end zohoapi
