...
public class WorkflowDashboard extends Composite {
	...
	public WorkflowDashboard() {
		...
		// Getting user tasks
		//findUserTaskInstances();		//commented by vissu on may18 for disable workflow
		
		// Getting pooled task instances
		//findPooledTaskInstances();	//commented by vissu on may18 for disable workflow
	...
	public void refreshAll() {
		//commented by vissu on may18 for disable workflow
