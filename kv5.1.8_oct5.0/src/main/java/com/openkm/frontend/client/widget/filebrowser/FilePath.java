...
public class FilePath  extends Composite {
	...
	public void setPath(String path) {
		...
		//vissu touch below block of code to change on oct'9th
				path = path.replaceAll("okm:root","Knowledge Vault");
				path = path.replaceAll("okm:template","Template");
				path = path.replaceAll("okm:personal","Personal");
				path = path.replaceAll("okm:trash","Trash");
