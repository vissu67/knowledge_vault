...
<head>
  ...
  <title>Knowledge Vault Mobile</title>
</head>
<body>
  ...
  <table class="results" >
    <tr><th colspan="2">Folder <span style="font-weight: normal">${pathDisplay}</span></th></tr>
    <tr><th>Property</th><th>Value</th></tr>
    <tr class="even"><td><b>UUID</b></td><td>${fld.uuid}</td></tr>
    <tr class="odd"><td><b>Name</b></td><td><u:getName path="${fld.path}"/></td></tr>
    <tr class="even"><td><b>Parent</b></td><td><a href="${urlBrowse}"><u:getParent path="${parentPathDisplay}"/></a></td></tr>
